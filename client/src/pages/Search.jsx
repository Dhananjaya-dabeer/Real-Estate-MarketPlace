        ...
        <div className=" p-7  border-b-2 md:border-r-2 md:min-h-screen">
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
               ...
               <div className='flex items-center gap-2'>
                ...
                <select onChange={handleChange} defaultValue={'created_at-desc'} id="sort_order" className='border rounded-lg p-3'>
        ...
        <div className="flex-1">
            ...
            <div className='p-7 flex  flex-wrap gap-4'>
                {isLoading ?(<div className='flex-1 flex items-center justify-center h-[60vh] '><img src='https://i.gifer.com/ZKZg.gif' alt='Loading....' className='self-center w-12 h-12'></img></div>) : (
                    ...
                    {showMore && 
                        <p onClick={onShowMoreClick} className='text-green-700 hover:underline w-full text-center cursor-pointer'>Show More</p>
                    }
            </div>
        </div>
    </div>

...
export default function UpdateListing() {
   ...
   const handleSubmit = async (e) => {
    ...
    try {
        ...
        setLoading(true)
        setError(false)
        let res = await fetch(`/api/listing/update/${listingId}`, {
            method:'POST',
            headers:{
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form  onSubmit={handleSubmit}  className='flex flex-col sm:flex-row gap-4'>
             ...
             <div className='flex gap-4'>
              ...
              <button className='p-3 bg-slate-700 text-white uppercase rounded-lg disabled:opacity-80 hover:opacity-95' disabled={loading || uploading}>{loading? 'updaing...' : 'update Listing' }</button>
